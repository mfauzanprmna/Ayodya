    ...
    <div class="A3 fw-bold " style="height: 942px ">
        ...
        <div class="row">
            <div class="col-sm-4" style="float: left">
                <img src="{{ public_path('/' . $siswas->kelass->image) }}" alt="" style=" width: 600px ;  
                position: absolute; top: 300px">
            </div>
            <div class="col-sm-8" style="margin-right: -100%; ">
                <center>
                ...
                <div class="container d-flex justify-content-between">
                    <div class="foto">
                        <img src="{{ public_path('/' . $siswas->foto) }}" alt="" id="foto" width="110px" height="150px"
