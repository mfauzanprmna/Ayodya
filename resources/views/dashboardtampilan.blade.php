...
<style>
        ...
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    ...
                    <h5 class="text-white op-7 mb-2">halaman tampilan depan</h5>
                </div>
    ...
    <div class="card-deck mt--4 mx-2 row d-flex align-items-center">
        <div class="col-sm-6">
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-9">
                            <div class="card-body">
                                ...
                                <p class="card-text">Dalam data siswa terdapat Foto No Induk Nama Siswa Tempat Tanggal
